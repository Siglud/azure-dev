...
// DRAFT ONLY: #10055 must merge and ship an SDK release before this can be removed.
// Replace the pinned azd requirement with that released version before merging.
